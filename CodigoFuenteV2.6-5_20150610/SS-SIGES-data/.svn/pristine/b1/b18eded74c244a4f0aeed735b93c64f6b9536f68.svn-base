            ...
            if (filtro.getCalidadIndice() != null && filtro.getCalidadIndice() > 0) {
                ...
                if (confAmarillo != null && confRojo != null) {
                    switch (filtro.getCalidadIndice()) {
                        case 1:
                            MatchCriteriaTO sinCalidad = CriteriaTOUtils.createMatchCriteriaTO(MatchCriteriaTO.types.NULL, "proyIndices.proyindCalInd", 1);
                            ...
                            OR_TO orProyAlta = CriteriaTOUtils.createORTO(calidadAlta, sinCalidad);
                            if (soloProyecto) {
                                criterias.add(orProyAlta);
                            } else {
                                MatchCriteriaTO sinCalidadProg = CriteriaTOUtils.createMatchCriteriaTO(MatchCriteriaTO.types.NULL, "proyProgFk.progIndices.progindCalInd", 1);
                                ...
                                OR_TO orProgAlta = CriteriaTOUtils.createORTO(sinCalidadProg, calidadAltaProg);
                                criterias.add(CriteriaTOUtils.createORTO(orProyAlta, orProgAlta));
                            }
                            break;
            ...
            if (confAmarillo != null && confRojo != null) {
                switch (filtro.getCalidadIndice()) {
                    case 1:
                        MatchCriteriaTO sinCalidad = CriteriaTOUtils.createMatchCriteriaTO(MatchCriteriaTO.types.NULL, "proyIndices.proyindCalInd", 1);
                        MatchCriteriaTO calidadAlta = CriteriaTOUtils.createMatchCriteriaTO(MatchCriteriaTO.types.GREATER, "proyIndices.proyindCalInd", Double.parseDouble(confAmarillo.getCnfValor()));
                        criterias.add(CriteriaTOUtils.createORTO(calidadAlta, sinCalidad));
                        break;
