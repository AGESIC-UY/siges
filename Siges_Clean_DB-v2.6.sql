CREATE DATABASE  IF NOT EXISTS `siges` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `siges`;
-- MySQL dump 10.13  Distrib 5.6.17, for Win32 (x86)
--
-- Host: localhost    Database: siges_clean_2_5
-- ------------------------------------------------------
...
CREATE TABLE `ss_configuraciones` (
  ...
  `cnf_codigo` varchar(45) DEFAULT NULL,
  `cnf_descripcion` varchar(45) DEFAULT NULL,
...
INSERT INTO `ss_usuario` VALUES (1,1,NULL,'admin','admin',0,NULL,NULL,'2014-09-12 12:33:00',NULL,NULL,NULL,NULL,NULL,NULL,'21232f297a57a5a743894a0e4a801fc3','Admin','Usuario',NULL,NULL,NULL,NULL,NULL,0,NULL,4,1,NULL,'admin','2014-09-12 12:33:00',NULL,NULL);
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `ss_oficina` AS select `organismos`.`org_pk` AS `ofi_id`,`organismos`.`org_nombre` AS `ofi_nombre`,now() AS `ofi_fecha_creacion`,'' AS `ofi_origen`,1 AS `ofi_usuario`,1 AS `ofi_version` from `organismos` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2015-05-19 16:21:47
