...
//                        ReporteAcumuladoMesTO acuMes = new ReporteAcumuladoMesTO(anioP, mesP);
//                        ultimoMes = acuMes;
...
//                            && (calAuxIni.get(Calendar.YEAR) <= calFin.get(Calendar.YEAR))) {
                    ...
                    if (primeraFecha != null && ultimaFecha != null) {
                        ...
                        if ((calAuxIni.get(Calendar.YEAR) > primeraFechaCal.get(Calendar.YEAR)
                            ...
                            prMes += presupuestoDelegate.obtenerPRPorMoneda(presupuesto.getPrePk(), adqPk, mon, anioP, mesP, false);
                            prAtrasadoMes += presupuestoDelegate.obtenerPRPorMoneda(presupuesto.getPrePk(), adqPk, mon, anioP, mesP, true);
                            ...
                            ReporteAcumuladoMesTO acuMes = new ReporteAcumuladoMesTO(anioP, mesP, null, pvMes, acMes, prMes, prAtrasadoMes, prNegativo, colorR);
//                        ultimoMes = acuMes;
                            acumulado.getMeses().add(acuMes);
                        }
                    }
//                    } else {
//                        ReporteAcumuladoMesTO acuMes = new ReporteAcumuladoMesTO(anioP, mesP, null, ultimoMes.getValorPlan(), null, ultimoMes.getValorProyectado(), ultimoMes.getValorProyectadoAtrasado(), false, ConstantesEstandares.COLOR_TRANSPARENT);
//                        ultimoMes = acuMes;
//                        acumulado.getMeses().add(acuMes);
//                    }
