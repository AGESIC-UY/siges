...
public class FechaConverter implements Converter{
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        try {
            SimpleDateFormat sdf = new SimpleDateFormat(ConstantesEstandares.CALENDAR_PATTERN);
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        if(value != null && value instanceof Date){
            return DatesUtils.toStringFormat((Date)value, ConstantesEstandares.CALENDAR_PATTERN);
        }
