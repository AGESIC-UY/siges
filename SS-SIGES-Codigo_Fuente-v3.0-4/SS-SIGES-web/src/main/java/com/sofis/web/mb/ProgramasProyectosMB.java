    ...
    public String inicioTooltipPresupuesto(FiltroInicioItem item, Integer monPk) {
        ...
        if (item != null && monPk != null) {
            ...
            if (((PV != null && PV != 0) || (AC != null && AC != 0))
                    || (PV != null && PV == 0 && AC != null && AC == 0
                    && item.getPresupuesto() != null && item.getPresupuesto().getPreBase() != null
                    && item.getPresupuesto().getPreBase() > 0 && item.getPresupuesto().getPreMoneda().equals(moneda))) {
