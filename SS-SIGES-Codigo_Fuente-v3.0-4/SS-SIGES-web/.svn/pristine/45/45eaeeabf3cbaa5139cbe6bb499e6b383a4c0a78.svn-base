...
public class ReportePresupuestoMB implements Serializable {
    ...
    private void cargarCombosFiltro() {
        ...
        listaInactivos = SsUsuariosUtils.sortByNombreApellido(listaInactivos);
        ...
        Date primeraDate = proyectoDelegate.obtenerPrimeraFecha();
        if (primeraDate != null) {
        ...
        Date ultimaDate = proyectoDelegate.obtenerUltimaFecha();
        if (ultimaDate != null) {
