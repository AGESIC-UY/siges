...
public class ReporteAcumuladoMesTO implements Serializable {
     ...
     */
    private Double valorProyectadoAtrasado = 0D;
    ...
    public ReporteAcumuladoMesTO(short anio, short mes, Integer objPk, Double valorPlan, Double valorReal, Double valorProyectado, Double valorProyectadoAtrasado, Boolean proyectadoNegativo, String colorReal) {
        this.anio = anio;
        this.mes = mes;
        this.objPk = objPk;
        this.valorPlan = valorPlan;
        ...
        this.valorProyectadoAtrasado = valorProyectadoAtrasado;
    ...
    public Double getValorProyectadoAtrasado() {
        return valorProyectadoAtrasado;
    }

    public void setValorProyectadoAtrasado(Double valorProyectadoAtrasado) {
        this.valorProyectadoAtrasado = valorProyectadoAtrasado;
    }

    public Boolean getProyectadoNegativo() {
    ...
    public Double getValorProyectadoTotal() {
        double vPr = valorProyectado != null ? valorProyectado : 0;
        double vPrAt = valorProyectadoAtrasado != null ? valorProyectadoAtrasado : 0;
        return vPr + vPrAt;
    }

    public boolean isProyectadoAtrasado() {

        return proyectadoNegativo != null ? proyectadoNegativo : (valorProyectadoAtrasado != null && valorProyectadoAtrasado > 0);
    }
}
