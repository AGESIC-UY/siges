...
public class FiltroInicioItem {
    ...
    HashMap<Integer, String> indiceMonedaColor;
    ...
    public void setInicioResultado(FiltroInicioResultadoTO inicioResultado) {
    ...
    public void setProgProyId(String progProyId) {
        this.progProyId = progProyId;
    }
    ...
    public boolean equals(Object object) {
        if (!(object instanceof FiltroInicioItem)) {
            return false;
        }
        FiltroInicioItem other = (FiltroInicioItem) object;
