...
public class ReporteAcumuladoTO implements Serializable {
    ...
    public void setMes(short anio, short mes, Integer objPk, Double plan, Double real, Double proyectado, boolean proyectadoNegativo, String colorR) {
        ReporteAcumuladoMesTO acuMes = new ReporteAcumuladoMesTO(anio, mes, objPk, plan, real, proyectado, proyectadoNegativo, colorR);
        this.getMeses().add(acuMes);
    }
}
