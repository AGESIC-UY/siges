...
public class PresupuestoBean {
    ...
    public String obtenerColorAC(Integer prePk, Integer monPk, Integer orgPk, Integer limiteAmarillo, Integer limiteRojo) {
        if (prePk != null && monPk != null) {
            ...
            return obtenerColorAC(pv, ac, null, null, orgPk, limiteAmarillo, limiteRojo, null, pre, mon);
        }
    ...
    public String obtenerColorACMensualProg(Integer progPk, Integer monPk, Integer orgPk, Double pv, Double ac, int anio, int mes, Integer limiteAmarillo, Integer limiteRojo) {
        if (progPk != null && monPk != null) {
            ...
            return obtenerColorAC(pv, ac, null, null, orgPk, limiteAmarillo, limiteRojo, cal);
        }
        return ConstantesEstandares.COLOR_TRANSPARENT;
    }
    ...
    public String obtenerColorAC(Double pv, Double ac, Double pr, Double prAtrasado, Integer orgPk, Integer limiteAmarillo, Integer limiteRojo, Calendar cal, Presupuesto pre, Moneda mon) {
        ...
        boolean tienePreBase = pre != null && mon != null && pre.getPreBase() != null && pre.getPreBase() > 0 && mon.equals(pre.getPreMoneda());

        if ((porcentajeAC >= (100 - limiteAmarillo) && porcentajeAC <= (100 + limiteAmarillo))
                || (porcentajeAC == 0 && tienePreBase)
                || (porcentajeAC == 0 && (proyectado + proyectadoAtrasado > 0))) {
    ...
    public Double obtenerPRPorMoneda(Integer prePk, Integer adqPk, Moneda mon, int anio, int mes, Boolean atrasado) {
        if (prePk != null && mon != null) {
            PresupuestoDAO pdao = new PresupuestoDAO(em);
            return pdao.obtenerPRPorMoneda(prePk, adqPk, mon, anio, mes, atrasado);
        }
        return 0D;
    }
    ...
    public Date obtenerPrimeraFechaPre(Integer prePk, Integer monPk) {
        if (prePk != null && monPk != null) {
            PresupuestoDAO dao = new PresupuestoDAO(em);
            return dao.obtenerPrimeraUltimaFechaPre(prePk, monPk, true);
        }
        return null;
    }
    ...
    public Date obtenerUltimaFechaPre(Integer prePk, Integer monPk) {
        if (prePk != null && monPk != null) {
            PresupuestoDAO dao = new PresupuestoDAO(em);
            return dao.obtenerPrimeraUltimaFechaPre(prePk, monPk, false);
        }
        return null;
    }
}
