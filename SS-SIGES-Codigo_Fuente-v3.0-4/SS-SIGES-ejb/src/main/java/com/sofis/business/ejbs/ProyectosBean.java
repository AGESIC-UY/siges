...
//                guardarIndicadoresYHermanos(proy.getProyPk(), orgPk);
    ...
    public Proyectos obtenerProyPorId(Integer id, Boolean loadOtrosDatos) throws GeneralException {
        if (id != null) {
            ...
            try {
                ...
                if (loadOtrosDatos != null && loadOtrosDatos) {
                    proy.getProyOtrosDatos();
                }
    ...
    public Proyectos copiarProyecto(Proyectos proy, String nombre, Date fechaComienzoProyCopia) {
        if (proy != null) {
            ...
            nvoProy.setProyOtrosDatos(proyOtrosDatosBean.copiarProyOtrosDatos(proy.getProyOtrosDatos()));
