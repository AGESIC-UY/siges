...
INSERT INTO `ss_rol` (`rol_cod`, `rol_descripcion`, `rol_nombre`, `rol_origen`, `rol_user_code`, `rol_vigente`) VALUES ('MIGRA_CALC_INDICA', 'Acceso a los callculos de la migración', 'MIGRA_CALC_INDICA', 'SIGES_WEB', '0', '1');
