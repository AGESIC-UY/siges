...
public class Util {
	...
	public static Element findElement(Element root, String localName,
			String namespace) {
	...
	public static List<Node> findAllElements(Element root, QName name,
			boolean local) {
	...
	public static Element findOrCreateSoapHeader(Element envelope) {
		...
		if (header == null) {
			header = envelope.getOwnerDocument().createElementNS(uri,
					prefix + ":Header");
	...
	public static String generateId(String prefix) {
		...
		id.append(prefix).append("-").append(count).append("-").append(time)
				.append("-").append(id.hashCode());
