 ...
 * @author Usuario
 */
public class ImporteDecimalFormatConverter implements Converter {
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        ...
        df.applyPattern(ConstantesEstandares.DECIMAL_FORMAT_PATTERN);
        
        String val = df.format(value);
//        System.out.println("VALOR IMPORTEDECIMALFORMATCONVERTE: "+ value +" -> "+ val);
        return val;
    }
}
