...
//
//	private static final Logger logger = Logger.getLogger(MultimediaUpload.class.getName());
...
//			try {
//				templateStream = this.getClass().getClassLoader().getResourceAsStream(nombreFile);
//				File tempDir = new File(System.getProperty("java.io.tmpdir"));
//				file = new File(tempDir, nombreFile);
//				fo = new FileOutputStream(file);
//				IOUtils.copy(templateStream, fo);
//			} catch (Exception ex) {
//				logger.log(Level.SEVERE, null, ex);
...
//					file = new File(tempDir, nombreFile);
//					fos = new FileOutputStream(file);
//					IOUtils.copy(templateStream, fos);
//				} catch (Exception ex) {
//					logger.log(Level.SEVERE, null, ex);
//					logger.log(Level.SEVERE, "Error al generar el logo del organismo.");
//				} finally {
...
//						fileInputStream.close();
//					} catch (IOException ex) {
//						Logger.getLogger(MultimediaUpload.class.getName()).log(Level.SEVERE, null, ex);
//					}
//				}
//			}
//
