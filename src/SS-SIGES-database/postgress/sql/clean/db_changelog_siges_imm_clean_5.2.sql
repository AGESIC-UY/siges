...
CREATE TABLE siges.aud_ss_localidades (loc_id INT4 NOT NULL, rev INT4 NOT NULL, revtype INT4, loc_codigo VARCHAR(255), loc_nombre VARCHAR(255), loc_ult_mod TIMESTAMP WITH TIME ZONE, loc_ult_origen VARCHAR(255), loc_ult_usuario VARCHAR(255), loc_version INT4, loc_depto_id INT4);
...
CREATE TABLE siges.organismos (org_pk SERIAL NOT NULL, org_nombre VARCHAR(45), org_logo_nombre VARCHAR(45), org_direccion VARCHAR(45), org_logo BYTEA, org_activo BOOL DEFAULT true NOT NULL, org_token VARCHAR(100), CONSTRAINT organismos_pkey PRIMARY KEY (org_pk));
...
CREATE TABLE siges.notificacion_instancia (notinst_pk SERIAL NOT NULL, notinst_not_fk INT4 NOT NULL, notinst_proy_fk INT4 NOT NULL, notinst_gerente_adjunto BOOL, notinst_pmof BOOL, notinst_pmot BOOL, notinst_sponsor BOOL, CONSTRAINT notificacion_instancia_pkey PRIMARY KEY (notinst_pk));
...
CREATE TABLE siges.componente_producto (com_pk SERIAL NOT NULL, com_nombre VARCHAR(100) NOT NULL, com_org_fk INT4 NOT NULL, com_version INT4 NOT NULL, CONSTRAINT componente_producto_pkey PRIMARY KEY (com_pk));
...
CREATE TABLE siges.registros_horas (rh_pk SERIAL NOT NULL, rh_usu_fk INT4 NOT NULL, rh_proy_fk INT4 NOT NULL, rh_ent_fk INT4 NOT NULL, rh_fecha date NOT NULL, rh_horas numeric NOT NULL, rh_comentario VARCHAR(4000), rh_aprobado BOOL, CONSTRAINT registros_horas_pkey PRIMARY KEY (rh_pk));
...
CREATE TABLE siges.prod_mes (prodmes_pk SERIAL NOT NULL, prodmes_prod_fk INT4 NOT NULL, prodmes_mes INT2 NOT NULL, prodmes_anio INT2 NOT NULL, prodmes_plan numeric NOT NULL, prodmes_real numeric, prodmes_acu_plan numeric NOT NULL, prodmes_acu_real numeric, CONSTRAINT prod_mes_pkey PRIMARY KEY (prodmes_pk));
...
CREATE TABLE siges.participantes (part_pk SERIAL NOT NULL, part_usu_fk INT4 NOT NULL, part_proy_fk INT4 NOT NULL, part_ent_fk INT4, part_horas_plan numeric, part_activo BOOL DEFAULT true NOT NULL, CONSTRAINT participantes_pkey PRIMARY KEY (part_pk));
...
CREATE TABLE siges.valor_hora (val_hor_pk SERIAL NOT NULL, val_hor_usu_fk INT4 NOT NULL, val_hor_org_fk INT4 NOT NULL, val_hor_mon_fk INT4 NOT NULL, val_hor_valor numeric NOT NULL, val_hor_anio INT4 NOT NULL, CONSTRAINT valor_hora_pkey PRIMARY KEY (val_hor_pk));
...
CREATE TABLE siges.prog_int (progint_prog_pk INT4 NOT NULL, progint_int_pk INT4 NOT NULL);
...
CREATE TABLE siges.ss_noticias (not_id SERIAL NOT NULL, not_ampliar VARCHAR(255), not_codigo VARCHAR(45), not_contenido TEXT, not_desde TIMESTAMP WITH TIME ZONE, not_hasta TIMESTAMP WITH TIME ZONE, not_imagen VARCHAR(255), not_titulo VARCHAR(255), not_ult_mod_fecha TIMESTAMP WITH TIME ZONE, not_ult_mod_origen VARCHAR(45), not_ult_mod_usuario VARCHAR(45), not_version INT4, CONSTRAINT ss_noticias_pkey PRIMARY KEY (not_id));
...
CREATE TABLE siges.plantilla_entregables (p_entregables_id SERIAL NOT NULL, p_entregables_nombre VARCHAR(1000), p_entregable_nivel INT4, p_entregable_esfuerzo INT4, p_entregable_duracion INT4, p_entregable_ant_fk INT4, p_entregable_p_cro_fk INT4, p_entregables_numero INT4, CONSTRAINT plantilla_entregables_pkey PRIMARY KEY (p_entregables_id));
...
CREATE TABLE siges.busq_filtro (busq_filtro_pk SERIAL NOT NULL, busq_filtro_usu_fk INT4 NOT NULL, busq_filtro_org_fk INT4 NOT NULL, busq_filtro_xml TEXT NOT NULL, CONSTRAINT busq_filtro_pkey PRIMARY KEY (busq_filtro_pk));
...
CREATE TABLE siges.estados (est_pk SERIAL NOT NULL, est_codigo VARCHAR(150), est_nombre VARCHAR(45), est_label VARCHAR(150), est_orden_proceso INT4, CONSTRAINT estados_pkey PRIMARY KEY (est_pk));
...
CREATE TABLE siges.ss_rol (rol_id SERIAL NOT NULL, rol_cod VARCHAR(255) NOT NULL, rol_descripcion TEXT, rol_nombre VARCHAR(255) NOT NULL, rol_label VARCHAR(150), rol_origen VARCHAR(255), rol_user_code INT4, rol_version INT4, rol_vigente BOOL, rol_tipo_usuario BOOL, CONSTRAINT ss_rol_pkey PRIMARY KEY (rol_id));
...
CREATE TABLE siges.ss_domicilios (dom_id SERIAL NOT NULL, dom_apto VARCHAR(50), dom_letra VARCHAR(255), dom_calle VARCHAR(150), dom_codigo_postal VARCHAR(5), dom_depto_alt VARCHAR(255), dom_descripcion TEXT, dom_inmueble_nombre VARCHAR(100), dom_kilometro VARCHAR(9), dom_manzana VARCHAR(5), dom_numero_puerta VARCHAR(5), dom_oficina VARCHAR(255), dom_ruta VARCHAR(5), dom_solar VARCHAR(5), dom_ult_mod TIMESTAMP WITH TIME ZONE, dom_ult_origen VARCHAR(255), dom_ult_usuario VARCHAR(255), dom_version INT4, dom_depto_id INT4, dom_loc_id INT4, dom_pai_id INT4, dom_par_id BOOL, dom_tec_id INT4, dom_tvi_id INT4, CONSTRAINT ss_domicilios_pkey PRIMARY KEY (dom_id));
...
CREATE TABLE siges.image (image_pk SERIAL NOT NULL, image_name VARCHAR(45) NOT NULL, image_desc VARCHAR(255) DEFAULT 'NULL::character varying', image_ext VARCHAR(20) NOT NULL, image_blob BYTEA NOT NULL, image_tipo INT4, image_orden INT4, CONSTRAINT image_pkey PRIMARY KEY (image_pk));
...
CREATE TABLE siges.aud_ss_rol (rol_id INT4 NOT NULL, rev INT4 NOT NULL, revtype INT4, rol_cod VARCHAR(255), rol_descripcion TEXT, rol_nombre VARCHAR(255), rol_label VARCHAR(150) NOT NULL, rol_origen VARCHAR(255), rol_user_code INT4, rol_version INT4, rol_vigente BOOL, rol_tipo_usuario BOOL);
...
CREATE TABLE siges.aud_ss_noticias (not_id INT4 NOT NULL, rev INT4 NOT NULL, revtype INT4, not_ampliar VARCHAR(255), not_codigo VARCHAR(45), not_contenido TEXT, not_desde TIMESTAMP WITH TIME ZONE, not_hasta TIMESTAMP WITH TIME ZONE, not_imagen VARCHAR(255), not_titulo VARCHAR(255), not_ult_mod_fecha TIMESTAMP WITH TIME ZONE, not_ult_mod_origen VARCHAR(45), not_ult_mod_usuario VARCHAR(45), not_version INT4);
...
CREATE TABLE siges.adquisicion (adq_pk SERIAL NOT NULL, adq_pre_fk INT4 NOT NULL, adq_nombre VARCHAR(300) NOT NULL, adq_prov_orga_fk INT4, adq_fuente_fk INT4, adq_moneda_fk INT4, adq_proc_compra VARCHAR(20), adq_proc_compra_grp VARCHAR(20), adq_componente_producto_fk INT4, adq_procedimiento_compra_fk INT4, adq_compartida_usuario_fk INT4, adq_compartida BOOL DEFAULT false NOT NULL, CONSTRAINT adquisicion_pkey PRIMARY KEY (adq_pk));
...
CREATE TABLE siges.tipos_media (tip_pk SERIAL NOT NULL, tip_cod VARCHAR(45), tip_nombre VARCHAR(245), CONSTRAINT tipos_media_pkey PRIMARY KEY (tip_pk));
...
CREATE TABLE siges.areas (area_pk SERIAL NOT NULL, area_org_fk INT4 NOT NULL, area_padre INT4, area_nombre VARCHAR(250), area_abreviacion VARCHAR(45), area_director INT4, area_activo BOOL DEFAULT true, area_habilitada BOOL DEFAULT true, CONSTRAINT areas_pkey PRIMARY KEY (area_pk));
...
CREATE TABLE siges.aud_ss_paridades (par_id BOOL NOT NULL, rev INT4 NOT NULL, revtype INT4, par_codigo VARCHAR(9), par_descripcion VARCHAR(45), par_ult_mod_fecha TIMESTAMP WITH TIME ZONE, par_ult_mod_origen VARCHAR(45), par_ult_mod_usuario VARCHAR(45), par_version INT4);
...
CREATE TABLE siges.aud_programas_proyectos (id VARCHAR(13) NOT NULL, rev INT4 NOT NULL, revtype INT4, activo BOOL, "areaNombre" VARCHAR(255), "areaPk" INT4, estado INT4, "estadoNombre" VARCHAR(255), "estadoPendiente" INT4, "fechaCrea" date, "fichaFk" INT4, gerente INT4, "gerentePrimerApellido" VARCHAR(255), "gerentePrimerNombre" VARCHAR(255), nombre VARCHAR(45), organismo INT4, "pmoFederada" INT4, "tipoFicha" INT8);
...
CREATE TABLE siges.ss_departamentos (depto_id SERIAL NOT NULL, depto_codigo VARCHAR(255), depto_nombre VARCHAR(255), depto_ult_mod TIMESTAMP WITH TIME ZONE, err_ult_origen VARCHAR(255), depto_ult_usuario VARCHAR(255), depto_version INT4, CONSTRAINT ss_departamentos_pkey PRIMARY KEY (depto_id));
...
CREATE TABLE siges.lecc_aprendidas (lecapr_pk SERIAL NOT NULL, lecapr_proy_fk INT4, lecapr_tipo_fk INT4 NOT NULL, lecapr_usr_fk INT4 NOT NULL, lecapr_org_fk INT4 NOT NULL, lecapr_fecha date NOT NULL, lecapr_desc VARCHAR(3000) NOT NULL, lecapr_activo BOOL, CONSTRAINT lecc_aprendidas_pkey PRIMARY KEY (lecapr_pk));
...
CREATE TABLE siges.fuente_financiamiento (fue_pk SERIAL NOT NULL, fue_nombre VARCHAR(300) NOT NULL, fue_org_fk INT4 NOT NULL, CONSTRAINT fuente_financiamiento_pkey PRIMARY KEY (fue_pk));
...
CREATE TABLE siges.etapa (eta_pk SERIAL NOT NULL, eta_org_fk INT4 NOT NULL, eta_codigo VARCHAR(45) NOT NULL, eta_nombre VARCHAR(100) NOT NULL, eta_label VARCHAR(100), CONSTRAINT etapa_pkey PRIMARY KEY (eta_pk));
...
CREATE TABLE siges.proy_lectura_area (proglectarea_area_pk INT4 NOT NULL, proglectarea_proy_pk INT4 NOT NULL);
...
CREATE TABLE siges.proy_tags (proytag_proy_pk INT4 NOT NULL, proytag_area_pk INT4 NOT NULL);
...
CREATE TABLE siges.sql_executed (sql_pk SERIAL NOT NULL, sql_ver_mayor INT4 NOT NULL, sql_ver_menor INT4 NOT NULL, sql_build INT4 NOT NULL, sql_desc TEXT, sql_fecha date, sql_update INT4 NOT NULL, CONSTRAINT sql_executed_pkey PRIMARY KEY (sql_pk));
...
CREATE TABLE siges.calidad (cal_pk SERIAL NOT NULL, cal_peso INT4 NOT NULL, cal_vca_fk INT4 NOT NULL, cal_actualizacion date NOT NULL, cal_tipo INT4 NOT NULL, cal_ent_fk INT4, cal_prod_fk INT4, cal_tca_fk INT4, cal_proy_fk INT4 NOT NULL, CONSTRAINT calidad_pkey PRIMARY KEY (cal_pk));
...
CREATE TABLE siges.tipo_gasto (tipogas_pk SERIAL NOT NULL, tipogas_org_fk INT4, tipogas_nombre VARCHAR(150) NOT NULL, CONSTRAINT tipo_gasto_pkey PRIMARY KEY (tipogas_pk));
...
CREATE TABLE siges.aud_ss_errores (id INT4 NOT NULL, rev INT4 NOT NULL, revtype INT4, err_codigo VARCHAR(255), err_descripcion VARCHAR(255), err_ult_mod TIMESTAMP WITH TIME ZONE, err_ult_origen VARCHAR(255), err_ult_usuario VARCHAR(255), err_version INT4);
...
CREATE TABLE siges.pge_invocaciones (inv_id SERIAL NOT NULL, inv_crea_usu VARCHAR(255), inv_env_fecha TIMESTAMP WITH TIME ZONE, inv_env_mensaje VARCHAR(255), inv_env_ok BOOL, inv_operacion VARCHAR(255), inv_rec_fecha TIMESTAMP WITH TIME ZONE, inv_rec_mensaje VARCHAR(255), inv_rec_ok BOOL, inv_servicio VARCHAR(255), inv_url VARCHAR(255), CONSTRAINT pge_invocaciones_pkey PRIMARY KEY (inv_id));
...
CREATE TABLE siges.ss_telefonos (tel_id SERIAL NOT NULL, tel_numero VARCHAR(25), tel_observaciones VARCHAR(255), tel_prefijo VARCHAR(10), tel_ult_mod TIMESTAMP WITH TIME ZONE, tel_ult_origen VARCHAR(45), tel_ult_usuario VARCHAR(45), tel_version INT4, tel_tiptel_id INT4, CONSTRAINT ss_telefonos_pkey PRIMARY KEY (tel_id));
...
CREATE TABLE siges.prog_docs_obl (progdocsobl_docs_pk INT4 NOT NULL, progdocsobl_prog_pk INT4 NOT NULL);
...
CREATE TABLE siges.plantilla_cronograma (p_crono_pk SERIAL NOT NULL, p_crono_nombre VARCHAR(845), p_crono_org_fk INT4, activo BOOL, CONSTRAINT plantilla_cronograma_pkey PRIMARY KEY (p_crono_pk));
...
CREATE TABLE siges.ss_categoper (cat_id SERIAL NOT NULL, cat_descripcion TEXT, cat_nombre VARCHAR(255) NOT NULL, cat_origen VARCHAR(255) NOT NULL, cat_user_code INT4 NOT NULL, cat_version INT4, cat_vigente BOOL, CONSTRAINT ss_categoper_pkey PRIMARY KEY (cat_id));
...
CREATE TABLE siges.ss_tipos_vialidad (tvi_id SERIAL NOT NULL, tvi_abreviacion VARCHAR(255), tvi_codigo VARCHAR(255), tvi_descripcion VARCHAR(255), tvi_ult_mod TIMESTAMP WITH TIME ZONE, tvi_ult_origen VARCHAR(255), tvi_ult_usuario VARCHAR(255), tvi_version INT4, CONSTRAINT ss_tipos_vialidad_pkey PRIMARY KEY (tvi_id));
...
CREATE TABLE siges.prog_indices_pre (progindpre_pk SERIAL NOT NULL, progindpre_progind_fk INT4 NOT NULL, progindpre_mon_fk INT4 NOT NULL, progindpre_total FLOAT8, progindpre_est_pre INT4, progindpre_anio FLOAT8, progindpre_ac FLOAT8, progindpre_pv FLOAT8, CONSTRAINT prog_indices_pre_pkey PRIMARY KEY (progindpre_pk));
...
CREATE TABLE siges.tipo_leccion (tipolec_pk SERIAL NOT NULL, tipolec_codigo VARCHAR(45), tipolec_nombre VARCHAR(150), CONSTRAINT tipo_leccion_pkey PRIMARY KEY (tipolec_pk));
...
CREATE TABLE siges.aud_ss_paises (pai_id INT4 NOT NULL, rev INT4 NOT NULL, revtype INT4, pai_codigo2 VARCHAR(255), pai_codigo3 VARCHAR(255), pai_comun BOOL, pai_habilitado BOOL, pai_nombre VARCHAR(255), pai_ult_mod TIMESTAMP WITH TIME ZONE, pai_ult_origen VARCHAR(255), pai_ult_usuario VARCHAR(255), pai_version INT4);
...
CREATE TABLE siges.ss_tipos_entrada_colectiva (tec_id SERIAL NOT NULL, tec_codigo VARCHAR(255), tec_descripcion VARCHAR(255), tec_ult_mod TIMESTAMP WITH TIME ZONE, tec_ult_origen VARCHAR(255), tec_ult_usuario VARCHAR(255), tec_version INT4, CONSTRAINT ss_tipos_entrada_colectiva_pkey PRIMARY KEY (tec_id));
...
CREATE TABLE siges.prog_pre (progpre_prog_fk INT4 NOT NULL, progpre_pre_fk INT4 NOT NULL);
...
CREATE TABLE siges.tipo_documento (tipdoc_pk SERIAL NOT NULL, tipodoc_nombre VARCHAR(145) NOT NULL, tipodoc_exigido_desde INT4, tipodoc_peso INT4, tipodoc_org_fk INT4, tipodoc_resum_ejecutivo BOOL, CONSTRAINT tipo_documento_pkey PRIMARY KEY (tipdoc_pk));
...
CREATE TABLE siges.proy_docs (proydoc_proy_pk INT4 NOT NULL, proydoc_doc_pk INT4 NOT NULL);
...
CREATE TABLE siges.proy_int (proyint_proy_pk INT4 NOT NULL, proyint_int_pk INT4 NOT NULL);
...
CREATE TABLE siges.productos (prod_pk SERIAL NOT NULL, prod_peso INT4 NOT NULL, prod_und_medida VARCHAR(45) NOT NULL, prod_ent_fk INT4 NOT NULL, prod_fecha_crea date NOT NULL, prod_ult_mod date, prod_acumulado BOOL, prod_desc VARCHAR(2000), CONSTRAINT productos_pkey PRIMARY KEY (prod_pk));
...
CREATE TABLE siges.proy_otros_datos (proy_otr_pk SERIAL NOT NULL, proy_otr_eta_fk INT4, proy_otr_cont_fk INT4, proy_otr_ins_eje_fk INT4, proy_otr_ent_fk INT4, proy_otr_origen VARCHAR(1000), proy_otr_plazo INT4, proy_otr_observaciones VARCHAR(4000), proy_otr_cat_fk INT4, proy_otr_est_pub_fk INT4, CONSTRAINT proy_otros_datos_pkey PRIMARY KEY (proy_otr_pk));
...
CREATE TABLE siges.area_conocimiento (con_pk SERIAL NOT NULL, con_nombre VARCHAR(150) NOT NULL, con_org_fk INT4 NOT NULL, con_padre_fk INT4, CONSTRAINT area_conocimiento_pkey PRIMARY KEY (con_pk));
...
CREATE TABLE siges.aud_doc_file (docfile_pk INT4 NOT NULL, rev INT4 NOT NULL, revtype INT2, docfile_nombre VARCHAR(255), docfile_path VARCHAR(255), docfile_ult_mod TIMESTAMP WITH TIME ZONE, docfile_ult_origen VARCHAR(255), docfile_ult_usuario VARCHAR(255), docfile_version INT4, docfile_doc_fk INT4);
...
CREATE TABLE siges.aud_ss_tipos_documento_persona (tipdocper_id INT4 NOT NULL, rev INT4 NOT NULL, revtype INT4, tipdocper_codigo VARCHAR(255), tipdocper_descripcion VARCHAR(255), tipdocper_habilitado BOOL, tipdocper_ult_mod TIMESTAMP WITH TIME ZONE, tipdocper_ult_origen VARCHAR(255), tipdocper_ult_usuario VARCHAR(255), tipdocper_version INT4);
...
CREATE TABLE siges.aud_ss_configuraciones (id INT4 NOT NULL, rev INT4 NOT NULL, revtype INT4, cnf_codigo VARCHAR(255), cnf_descripcion VARCHAR(255), cnf_html BOOL, cnf_protegido BOOL, cnf_ult_mod TIMESTAMP WITH TIME ZONE, cnf_ult_origen VARCHAR(255), cnf_ult_usuario VARCHAR(255), cnf_valor TEXT, cnf_version INT4);
...
CREATE TABLE siges.gastos (gas_pk SERIAL NOT NULL, gas_proy_fk INT4 NOT NULL, gas_tipo_fk INT4 NOT NULL, gas_usu_fk INT4 NOT NULL, gas_mon_fk INT4 NOT NULL, gas_importe numeric NOT NULL, gas_fecha date NOT NULL, gas_obs VARCHAR(4000) NOT NULL, gas_aprobado BOOL, CONSTRAINT gastos_pkey PRIMARY KEY (gas_pk));
...
CREATE TABLE siges.areas_tags (arastag_pk SERIAL NOT NULL, areatag_org_fk INT4 NOT NULL, areatag_padre_fk INT4, areatag_tematica VARCHAR(45), areatag_excluyente BOOL, areatag_nombre VARCHAR(45), areatag_categoria VARCHAR(45), CONSTRAINT areas_tags_pkey PRIMARY KEY (arastag_pk));
...
CREATE TABLE siges.lecapr_areacon (lecaprcon_con_fk INT4 NOT NULL, lecaprcon_lecapr_fk INT4 NOT NULL);
...
CREATE TABLE siges.moneda (mon_pk SERIAL NOT NULL, mon_nombre VARCHAR(100) NOT NULL, mon_signo VARCHAR(50), mon_cod_pais VARCHAR(10), CONSTRAINT moneda_pkey PRIMARY KEY (mon_pk));
...
CREATE TABLE siges.aud_ss_departamentos (depto_id INT4 NOT NULL, rev INT4 NOT NULL, revtype INT4, depto_codigo VARCHAR(255), depto_nombre VARCHAR(255), depto_ult_mod TIMESTAMP WITH TIME ZONE, err_ult_origen VARCHAR(255), depto_ult_usuario VARCHAR(255), depto_version INT4);
...
CREATE TABLE siges.roles_interesados (rolint_pk SERIAL NOT NULL, rolint_org_fk INT4 NOT NULL, rolint_nombre VARCHAR(45), CONSTRAINT roles_interesados_pkey PRIMARY KEY (rolint_pk));
...
CREATE TABLE siges.aud_ss_tipos_telefono ("tipTel_id" INT4 NOT NULL, rev INT4 NOT NULL, revtype INT4, "tipTel_codigo" VARCHAR(255), "tipTel_descripcion" VARCHAR(255), "tipTel_habilitado" BOOL, "tipTel_ult_mod" TIMESTAMP WITH TIME ZONE, "tipTel_ult_origen" VARCHAR(255), "tipTel_ult_usuario" VARCHAR(255), "tipTel_version" INT4);
...
CREATE TABLE siges.ss_ayuda (ayu_id SERIAL NOT NULL, ayu_codigo VARCHAR(45), ayu_texto TEXT, ayu_ult_mod_fecha TIMESTAMP WITH TIME ZONE, ayu_ult_mod_origen VARCHAR(45), ayu_ult_mod_usuario VARCHAR(45), ayu_version INT4, CONSTRAINT ss_ayuda_pkey PRIMARY KEY (ayu_id));
...
CREATE TABLE siges.ambito (amb_pk SERIAL NOT NULL, amb_nombre VARCHAR(100) NOT NULL, amb_org_fk INT4 NOT NULL, CONSTRAINT ambito_pkey PRIMARY KEY (amb_pk));
...
CREATE TABLE siges.devengado (dev_pk SERIAL NOT NULL, dev_adq_fk INT4 NOT NULL, dev_mes INT2 NOT NULL, dev_anio INT2 NOT NULL, dev_plan numeric, dev_real numeric, CONSTRAINT devengado_pkey PRIMARY KEY (dev_pk));
...
CREATE TABLE siges.interesados (int_pk SERIAL NOT NULL, int_rolint_fk INT4 NOT NULL, int_observaciones VARCHAR(4000), int_pers_fk INT4, int_orga_fk INT4, int_ent_fk INT4, CONSTRAINT interesados_pkey PRIMARY KEY (int_pk));
...
CREATE TABLE siges.proy_otros_cat_secundarias (proy_cat_proy_otros_fk INT4 NOT NULL, proy_cat_cat_proy_fk INT4 NOT NULL);
...
CREATE TABLE siges.proy_sitact_historico (proy_sitact_hist_pk SERIAL NOT NULL, proy_sitact_fecha date NOT NULL, proy_sitact_desc VARCHAR(4000), proy_sitact_proy_fk INT4 NOT NULL, proy_sitact_usu_fk INT4, "version" INT4, CONSTRAINT proy_sitact_historico_pkey PRIMARY KEY (proy_sitact_hist_pk));
...
CREATE TABLE siges.estados_sigesacion (est_pub_pk SERIAL NOT NULL, est_pub_codigo VARCHAR(45), est_pub_nombre VARCHAR(145), CONSTRAINT estados_sigesacion_pkey PRIMARY KEY (est_pub_pk));
...
CREATE TABLE siges.prog_docs (progdocs_prog_pk INT4 NOT NULL, progdocs_doc_pk INT4 NOT NULL);
...
CREATE TABLE siges.ent_hist_linea_base (enthist_pk SERIAL NOT NULL, enthist_ent_fk INT4 NOT NULL, enthist_fecha date NOT NULL, enthist_inicio_linea_base INT8 NOT NULL, enthist_fin_linea_base INT8, enthist_duracion INT4, enthist_replan_fk INT4, CONSTRAINT ent_hist_linea_base_pkey PRIMARY KEY (enthist_pk));
...
CREATE TABLE siges.lineabase_historico (lineabase_pk SERIAL NOT NULL, "lineabase_entFk" INT4 NOT NULL, lineabase_fecha date NOT NULL, lineabase_inicio INT8 NOT NULL, lineabase_duracion INT4, lineabase_fin INT8 NOT NULL, CONSTRAINT lineabase_historico_pkey PRIMARY KEY (lineabase_pk));
...
CREATE TABLE siges.aud_ss_ayuda (ayu_id INT4 NOT NULL, rev INT4 NOT NULL, revtype INT4, ayu_codigo VARCHAR(45), ayu_texto TEXT, ayu_ult_mod_fecha TIMESTAMP WITH TIME ZONE, ayu_ult_mod_origen VARCHAR(45), ayu_ult_mod_usuario VARCHAR(45), ayu_version INT4);
...
CREATE TABLE siges.cronogramas (cro_pk SERIAL NOT NULL, cro_ent_seleccionado INT4, cro_ent_borrados VARCHAR(45), cro_resources VARCHAR(45), cro_permiso_escritura BOOL, cro_permiso_escritura_padre BOOL, CONSTRAINT cronogramas_pkey PRIMARY KEY (cro_pk));
...
CREATE TABLE siges.aud_ss_telefonos (tel_id INT4 NOT NULL, rev INT4 NOT NULL, revtype INT4, tel_numero VARCHAR(25), tel_observaciones VARCHAR(255), tel_prefijo VARCHAR(10), tel_ult_mod TIMESTAMP WITH TIME ZONE, tel_ult_origen VARCHAR(45), tel_ult_usuario VARCHAR(45), tel_version INT4, tel_tiptel_id INT4);
...
CREATE TABLE siges.proy_indices_pre (proyindpre_pk SERIAL NOT NULL, proyindpre_proyind_fk INT4 NOT NULL, proyindpre_mon_fk INT4 NOT NULL, proyindpre_total FLOAT8, proyindpre_est_pre INT4, proyindpre_ac FLOAT8, proyindpre_pv FLOAT8, proyindpre_anio FLOAT8, CONSTRAINT proy_indices_pre_pkey PRIMARY KEY (proyindpre_pk));
...
CREATE TABLE siges.departamentos (dep_pk INT4 NOT NULL, dep_nombre VARCHAR(145), dep_lat FLOAT8, dep_lng FLOAT8, dep_zoom INT4);
...
CREATE TABLE siges.objetivos_estrategicos (obj_est_pk SERIAL NOT NULL, obj_est_nombre VARCHAR(100) NOT NULL, obj_est_descripcion VARCHAR(100) NOT NULL, obj_est_org_fk INT4 NOT NULL, CONSTRAINT objetivos_estrategicos_pkey PRIMARY KEY (obj_est_pk));
...
CREATE TABLE siges.revinfo (rev SERIAL NOT NULL, revtstmp INT8, "version" INT4 DEFAULT 0, CONSTRAINT revinfo_pkey PRIMARY KEY (rev));
...
CREATE TABLE siges.ss_paises (pai_id SERIAL NOT NULL, pai_codigo2 VARCHAR(255), pai_codigo3 VARCHAR(255), pai_comun BOOL, pai_habilitado BOOL, pai_nombre VARCHAR(255), pai_ult_mod TIMESTAMP WITH TIME ZONE, pai_ult_origen VARCHAR(255), pai_ult_usuario VARCHAR(255), pai_version INT4, CONSTRAINT ss_paises_pkey PRIMARY KEY (pai_id));
...
CREATE TABLE siges.aud_ss_usu_ofi_roles (usu_ofi_roles_id INT4 NOT NULL, rev INT4 NOT NULL, revtype INT4, usu_ofi_roles_origen VARCHAR(255), usu_ofi_roles_user_code INT4, usu_ofi_roles_oficina INT4, usu_ofi_roles_rol INT4, usu_ofi_roles_usuario INT4, usu_ofi_roles_activo BOOL);
...
CREATE TABLE siges.roles_usuarios (rol_pk INT4 NOT NULL, rol_nombre VARCHAR(45));
...
CREATE TABLE siges.aud_ss_domicilios (dom_id INT4 NOT NULL, rev INT4 NOT NULL, revtype INT4, dom_apto VARCHAR(50), dom_letra VARCHAR(255), dom_calle VARCHAR(150), dom_codigo_postal VARCHAR(5), dom_depto_alt VARCHAR(255), dom_descripcion TEXT, dom_inmueble_nombre VARCHAR(100), dom_kilometro VARCHAR(9), dom_manzana VARCHAR(5), dom_numero_puerta VARCHAR(5), dom_oficina VARCHAR(255), dom_ruta VARCHAR(5), dom_solar VARCHAR(5), dom_ult_mod TIMESTAMP WITH TIME ZONE, dom_ult_origen VARCHAR(255), dom_ult_usuario VARCHAR(255), dom_version INT4, dom_depto_id INT4, dom_loc_id INT4, dom_pai_id INT4, dom_par_id BOOL, dom_tec_id INT4, dom_tvi_id INT4);
...
CREATE TABLE siges.notificacion (not_pk SERIAL NOT NULL, not_org_fk INT4 NOT NULL, not_cod VARCHAR(45) NOT NULL, not_desc VARCHAR(245) NOT NULL, not_valor INT4, not_gerente_adjunto BOOL, not_pmof BOOL, not_pmot BOOL, not_sponsor BOOL, not_msg VARCHAR(5000) NOT NULL, CONSTRAINT notificacion_pkey PRIMARY KEY (not_pk));
...
CREATE TABLE siges.aud_ss_oficina (ofi_id INT4 NOT NULL, rev INT4 NOT NULL, revtype INT4, ofi_fecha_creacion TIMESTAMP WITH TIME ZONE, ofi_nombre VARCHAR(255), ofi_origen VARCHAR(255), ofi_usuario INT4, ofi_version INT4, ofi_activo BOOL);
...
CREATE TABLE siges.ss_paridades (par_id BOOL NOT NULL, par_codigo VARCHAR(9), par_descripcion VARCHAR(45), par_ult_mod_fecha TIMESTAMP WITH TIME ZONE, par_ult_mod_origen VARCHAR(45), par_ult_mod_usuario VARCHAR(45), par_version INT4);
...
CREATE TABLE siges.presupuesto (pre_pk SERIAL NOT NULL, pre_base numeric, pre_moneda INT4, pre_fuente_organi_fk INT4, CONSTRAINT presupuesto_pkey PRIMARY KEY (pre_pk));
...
CREATE TABLE siges.area_organi_int_prove (areaorgintprov_pk SERIAL NOT NULL, areaorgintprov_orga_fk INT4 NOT NULL, areaorgintprov_org_fk INT4 NOT NULL, areaorgintprov_nombre VARCHAR(40), CONSTRAINT area_organi_int_prove_pkey PRIMARY KEY (areaorgintprov_pk));
...
CREATE TABLE siges.ss_localidades (loc_id SERIAL NOT NULL, loc_codigo VARCHAR(255), loc_nombre VARCHAR(255), loc_ult_mod TIMESTAMP WITH TIME ZONE, loc_ult_origen VARCHAR(255), loc_ult_usuario VARCHAR(255), loc_version INT4, loc_depto_id INT4, CONSTRAINT ss_localidades_pkey PRIMARY KEY (loc_id));
...
CREATE TABLE siges.valor_calidad_codigos (vca_pk SERIAL NOT NULL, vca_codigo VARCHAR(45) NOT NULL, vca_nombre VARCHAR(100) NOT NULL, vca_habilitado BOOL NOT NULL, CONSTRAINT valor_calidad_codigos_pkey PRIMARY KEY (vca_pk));
...
CREATE TABLE siges.prog_lectura_area (proglectarea_prog_pk INT4 NOT NULL, proglectarea_area_pk INT4 NOT NULL);
...
CREATE TABLE siges.temas_calidad (tca_pk SERIAL NOT NULL, tca_nombre VARCHAR(100) NOT NULL, tca_org_fk INT4 NOT NULL, CONSTRAINT temas_calidad_pkey PRIMARY KEY (tca_pk));
...
CREATE TABLE siges.mails_template (mail_tmp_pk SERIAL NOT NULL, mail_tmp_cod VARCHAR(45) NOT NULL, mail_tmp_org_fk INT4 NOT NULL, mail_tmp_asunto VARCHAR(200) NOT NULL, mail_tmp_mensaje VARCHAR(5000) NOT NULL, CONSTRAINT mails_template_pkey PRIMARY KEY (mail_tmp_pk));
...
CREATE TABLE siges.ss_errores (id INT4 NOT NULL, err_codigo VARCHAR(255), err_descripcion VARCHAR(255), err_ult_mod TIMESTAMP WITH TIME ZONE, err_ult_origen VARCHAR(255), err_ult_usuario VARCHAR(255), err_version INT4);
...
CREATE TABLE siges.proy_pre (proypre_proy_fk INT4 NOT NULL, proypre_pre_fk INT4 NOT NULL);
...
CREATE TABLE siges.aud_ss_tipos_vialidad (tvi_id INT4 NOT NULL, rev INT4 NOT NULL, revtype INT4, tvi_abreviacion VARCHAR(255), tvi_codigo VARCHAR(255), tvi_descripcion VARCHAR(255), tvi_ult_mod TIMESTAMP WITH TIME ZONE, tvi_ult_origen VARCHAR(255), tvi_ult_usuario VARCHAR(255), tvi_version INT4);
...
CREATE TABLE siges.notificacion_envio (notenv_pk SERIAL NOT NULL, notenv_fecha date NOT NULL, notenv_proy_fk INT4 NOT NULL, notenv_not_cod VARCHAR(45) NOT NULL, CONSTRAINT notificacion_envio_pkey PRIMARY KEY (notenv_pk));
...
CREATE TABLE siges.ss_configuraciones (id SERIAL NOT NULL, cnf_org_fk INT4, cnf_codigo VARCHAR(145), cnf_descripcion VARCHAR(245), cnf_valor VARCHAR(255), cnf_protegido BOOL, cnf_html BOOL, cnf_ult_usuario VARCHAR(45), cnf_ult_mod VARCHAR(45), cnf_version INT4, cnf_ult_origen VARCHAR(50), CONSTRAINT ss_configuraciones_pkey PRIMARY KEY (id));
...
CREATE TABLE siges.aud_ss_categoper (cat_id INT4 NOT NULL, rev INT4 NOT NULL, revtype INT4, cat_descripcion TEXT, cat_nombre VARCHAR(255), cat_origen VARCHAR(255), cat_user_code INT4, cat_version INT4, cat_vigente BOOL);
...
CREATE TABLE siges.aud_ss_operacion (ope_id INT4 NOT NULL, rev INT4 NOT NULL, revtype INT4, ope_codigo VARCHAR(255), ope_descripcion TEXT, ope_nombre VARCHAR(255), ope_origen VARCHAR(255), ope_tipocampo VARCHAR(255), ope_user_code INT4, ope_version INT4, ope_vigente BOOL, ope_categoria_id INT4);
...
CREATE TABLE siges.latlng_proyectos (latlng_pk SERIAL NOT NULL, latlng_lat numeric, latlng_lng numeric, latlng_proy_fk INT4, latlang_dep_fk INT4, latlang_loc_fk INT4, latlang_codigopostal INT4, latlang_barrio VARCHAR(245), latlang_loc VARCHAR(245), CONSTRAINT latlng_proyectos_pkey PRIMARY KEY (latlng_pk));
...
CREATE TABLE siges.aud_pge_configuraciones (cnf_id INT4 NOT NULL, rev INT4 NOT NULL, revtype INT4, cnf_clave VARCHAR(255), cnf_crea_fecha TIMESTAMP WITH TIME ZONE, cnf_crea_origen INT4, cnf_crea_usu VARCHAR(255), cnf_ultmod_fecha TIMESTAMP WITH TIME ZONE, cnf_ultmod_origen INT4, cnf_ultmod_usu VARCHAR(255), cnf_valor VARCHAR(255), cnf_version INT4);
...
CREATE TABLE siges.personas (pers_pk SERIAL NOT NULL, pers_rol_fk INT4 NOT NULL, pers_orga_fk INT4 NOT NULL, pers_nombre VARCHAR(45) NOT NULL, pers_telefono VARCHAR(45), pers_cargo VARCHAR(45), pers_mail VARCHAR(45), CONSTRAINT personas_pkey PRIMARY KEY (pers_pk));
...
CREATE TABLE siges.proy_sigesa_hist (proy_sigesa_pk SERIAL NOT NULL, proy_sigesa_fecha TIMESTAMP WITH TIME ZONE NOT NULL, proy_sigesa_proy_fk INT4 NOT NULL, proy_sigesa_usu_fk INT4 NOT NULL, CONSTRAINT proy_sigesa_hist_pkey PRIMARY KEY (proy_sigesa_pk));
...
CREATE TABLE siges.ss_usuarios_datos (ss_usu_dat_pk SERIAL NOT NULL, ss_usu_dat_area_fk INT4 NOT NULL, ss_usu_dat_usu_fk INT4 NOT NULL, CONSTRAINT ss_usuarios_datos_pkey PRIMARY KEY (ss_usu_dat_pk));
...
CREATE TABLE siges.aud_ss_tipos_entrada_colectiva (tec_id INT4 NOT NULL, rev INT4 NOT NULL, revtype INT4, tec_codigo VARCHAR(255), tec_descripcion VARCHAR(255), tec_ult_mod TIMESTAMP WITH TIME ZONE, tec_ult_origen VARCHAR(255), tec_ult_usuario VARCHAR(255), tec_version INT4);
...
CREATE TABLE siges.prog_tags (progtag_prog_pk INT4 NOT NULL, progtag_area_pk INT4 NOT NULL);
...
ALTER TABLE siges.aud_programas_proyectos ADD CONSTRAINT aud_programas_proyectos_pkey PRIMARY KEY (id, rev);
...
ALTER TABLE siges.aud_ss_tipos_telefono ADD CONSTRAINT aud_ss_tipos_telefono_pkey PRIMARY KEY ("tipTel_id", rev);
...
ALTER TABLE siges.aud_ss_personas ADD CONSTRAINT aud_ss_personas_pkey PRIMARY KEY (per_id, rev);
...
ALTER TABLE siges.proy_otros_cat_secundarias ADD CONSTRAINT proy_otros_cat_secundarias_pkey PRIMARY KEY (proy_cat_proy_otros_fk, proy_cat_cat_proy_fk);
...
ALTER TABLE siges.aud_ss_noticias ADD CONSTRAINT aud_ss_noticias_pkey PRIMARY KEY (not_id, rev);
...
ALTER TABLE siges.aud_ss_tipos_entrada_colectiva ADD CONSTRAINT aud_ss_tipos_entrada_colectiva_pkey PRIMARY KEY (tec_id, rev);
...
ALTER TABLE siges.aud_ss_ayuda ADD CONSTRAINT aud_ss_ayuda_pkey PRIMARY KEY (ayu_id, rev);
...
ALTER TABLE siges.prog_lectura_area ADD CONSTRAINT prog_lectura_area_pkey PRIMARY KEY (proglectarea_prog_pk, proglectarea_area_pk);
...
ALTER TABLE siges.proy_pre ADD CONSTRAINT proy_pre_pkey PRIMARY KEY (proypre_proy_fk);
...
ALTER TABLE siges.proy_docs ADD CONSTRAINT proy_docs_pkey PRIMARY KEY (proydoc_proy_pk, proydoc_doc_pk);
...
ALTER TABLE siges.aud_ss_paridades ADD CONSTRAINT aud_ss_paridades_pkey PRIMARY KEY (par_id, rev);
...
ALTER TABLE siges.aud_ss_departamentos ADD CONSTRAINT aud_ss_departamentos_pkey PRIMARY KEY (depto_id, rev);
...
ALTER TABLE siges.aud_ss_paises ADD CONSTRAINT aud_ss_paises_pkey PRIMARY KEY (pai_id, rev);
...
ALTER TABLE siges.aud_ss_operacion ADD CONSTRAINT aud_ss_operacion_pkey PRIMARY KEY (ope_id, rev);
...
ALTER TABLE siges.prog_tags ADD CONSTRAINT prog_tags_pkey PRIMARY KEY (progtag_prog_pk, progtag_area_pk);
...
ALTER TABLE siges.aud_pge_configuraciones ADD CONSTRAINT aud_pge_configuraciones_pkey PRIMARY KEY (cnf_id, rev);
...
ALTER TABLE siges.aud_ss_domicilios ADD CONSTRAINT aud_ss_domicilios_pkey PRIMARY KEY (dom_id, rev);
...
ALTER TABLE siges.aud_ss_usu_ofi_roles ADD CONSTRAINT aud_ss_usu_ofi_roles_pkey PRIMARY KEY (usu_ofi_roles_id, rev);
...
ALTER TABLE siges.roles_usuarios ADD CONSTRAINT roles_usuarios_pkey PRIMARY KEY (rol_pk);
...
ALTER TABLE siges.aud_ss_categoper ADD CONSTRAINT aud_ss_categoper_pkey PRIMARY KEY (cat_id, rev);
...
ALTER TABLE siges.aud_ss_usuario ADD CONSTRAINT aud_ss_usuario_pkey PRIMARY KEY (usu_id, rev);
...
ALTER TABLE siges.aud_ss_tipos_vialidad ADD CONSTRAINT aud_ss_tipos_vialidad_pkey PRIMARY KEY (tvi_id, rev);
...
ALTER TABLE siges.aud_doc_file ADD CONSTRAINT aud_doc_file_pkey PRIMARY KEY (docfile_pk, rev);
...
ALTER TABLE siges.aud_ss_rol ADD CONSTRAINT aud_ss_rol_pkey PRIMARY KEY (rol_id, rev);
...
ALTER TABLE siges.lecapr_areacon ADD CONSTRAINT lecapr_areacon_pkey PRIMARY KEY (lecaprcon_con_fk, lecaprcon_lecapr_fk);
...
ALTER TABLE siges.aud_ss_rel_rol_operacion ADD CONSTRAINT aud_ss_rel_rol_operacion_pkey PRIMARY KEY (rel_rol_operacion_id, rev);
...
ALTER TABLE siges.prog_docs_obl ADD CONSTRAINT prog_docs_obl_pkey PRIMARY KEY (progdocsobl_docs_pk, progdocsobl_prog_pk);
...
ALTER TABLE siges.aud_programas ADD CONSTRAINT aud_programas_pkey PRIMARY KEY (prog_pk, rev);
...
ALTER TABLE siges.aud_ss_localidades ADD CONSTRAINT aud_ss_localidades_pkey PRIMARY KEY (loc_id, rev);
...
ALTER TABLE siges.prog_int ADD CONSTRAINT prog_int_pkey PRIMARY KEY (progint_prog_pk, progint_int_pk);
...
ALTER TABLE siges.proy_lectura_area ADD CONSTRAINT proy_lectura_area_pkey PRIMARY KEY (proglectarea_area_pk, proglectarea_proy_pk);
...
ALTER TABLE siges.prog_pre ADD CONSTRAINT prog_pre_pkey PRIMARY KEY (progpre_prog_fk);
...
ALTER TABLE siges.aud_ss_configuraciones ADD CONSTRAINT aud_ss_configuraciones_pkey PRIMARY KEY (id, rev);
...
ALTER TABLE siges.proy_tags ADD CONSTRAINT proy_tags_pkey PRIMARY KEY (proytag_proy_pk, proytag_area_pk);
...
ALTER TABLE siges.ss_paridades ADD CONSTRAINT ss_paridades_pkey PRIMARY KEY (par_id);
...
ALTER TABLE siges.departamentos ADD CONSTRAINT departamentos_pkey PRIMARY KEY (dep_pk);
...
ALTER TABLE siges.aud_ss_oficina ADD CONSTRAINT aud_ss_oficina_pkey PRIMARY KEY (ofi_id, rev);
...
ALTER TABLE siges.prog_docs ADD CONSTRAINT prog_docs_pkey PRIMARY KEY (progdocs_prog_pk, progdocs_doc_pk);
...
ALTER TABLE siges.ss_errores ADD CONSTRAINT ss_errores_pkey PRIMARY KEY (id);
...
ALTER TABLE siges.proy_int ADD CONSTRAINT proy_int_pkey PRIMARY KEY (proyint_proy_pk, proyint_int_pk);
...
ALTER TABLE siges.aud_ss_errores ADD CONSTRAINT aud_ss_errores_pkey PRIMARY KEY (id, rev);
...
ALTER TABLE siges.aud_ss_telefonos ADD CONSTRAINT aud_ss_telefonos_pkey PRIMARY KEY (tel_id, rev);
...
ALTER TABLE siges.aud_ss_tipos_documento_persona ADD CONSTRAINT aud_ss_tipos_documento_persona_pkey PRIMARY KEY (tipdocper_id, rev);
...
ALTER TABLE siges.proy_lectura_area ADD CONSTRAINT proy_lectura_area_proglectarea_area_pk_fkey FOREIGN KEY (proglectarea_area_pk) REFERENCES siges.areas (area_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.proy_tags ADD CONSTRAINT proy_tags_proytag_area_pk_fkey FOREIGN KEY (proytag_area_pk) REFERENCES siges.areas_tags (arastag_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.proy_otros_datos ADD CONSTRAINT proy_otros_datos_proy_otr_cat_fk_fkey FOREIGN KEY (proy_otr_cat_fk) REFERENCES siges.categoria_proyectos (cat_proy_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.prog_int ADD CONSTRAINT prog_int_progint_int_pk_fkey FOREIGN KEY (progint_int_pk) REFERENCES siges.interesados (int_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.categoria_proyectos ADD CONSTRAINT fk_hb3weyc8xvdrbp62k3u1halnb FOREIGN KEY (cat_icono_marker) REFERENCES siges.image (image_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.prog_indices_pre ADD CONSTRAINT prog_indices_pre_progindpre_progind_fk_fkey FOREIGN KEY (progindpre_progind_fk) REFERENCES siges.prog_indices (progind_pk) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE siges.prog_docs_obl ADD CONSTRAINT prog_docs_obl_progdocsobl_docs_pk_fkey FOREIGN KEY (progdocsobl_docs_pk) REFERENCES siges.documentos (docs_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.lecapr_areacon ADD CONSTRAINT lecapr_areacon_lecaprcon_con_fk_fkey FOREIGN KEY (lecaprcon_con_fk) REFERENCES siges.area_conocimiento (con_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.areas_tags ADD CONSTRAINT areas_tags_areatag_padre_fk_fkey FOREIGN KEY (areatag_padre_fk) REFERENCES siges.areas_tags (arastag_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.notificacion_instancia ADD CONSTRAINT notificacion_instancia_notinst_not_fk_fkey FOREIGN KEY (notinst_not_fk) REFERENCES siges.notificacion (not_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.proyectos ADD CONSTRAINT proyectos_proy_area_fk_fkey FOREIGN KEY (proy_area_fk) REFERENCES siges.areas (area_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.proy_indices ADD CONSTRAINT proyind_periodo_fin_ent_fk FOREIGN KEY (proyind_periodo_fin_ent_fk) REFERENCES siges.entregables (ent_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.proy_sigesa_hist ADD CONSTRAINT proy_sigesa_proy_fk FOREIGN KEY (proy_sigesa_proy_fk) REFERENCES siges.proyectos (proy_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.ss_operacion ADD CONSTRAINT ss_operacion_ope_categoria_id_fkey FOREIGN KEY (ope_categoria_id) REFERENCES siges.ss_categoper (cat_id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE siges.proy_int ADD CONSTRAINT proy_int_proyint_int_pk_fkey FOREIGN KEY (proyint_int_pk) REFERENCES siges.interesados (int_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.prog_lectura_area ADD CONSTRAINT prog_lectura_area_proglectarea_area_pk_fkey FOREIGN KEY (proglectarea_area_pk) REFERENCES siges.areas (area_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.tipo_documento_instancia ADD CONSTRAINT tipo_documento_instancia_tipodoc_inst_tipodoc_fk_fkey FOREIGN KEY (tipodoc_inst_tipodoc_fk) REFERENCES siges.tipo_documento (tipdoc_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.tipo_documento ADD CONSTRAINT tipo_documento_tipodoc_org_fk_fkey FOREIGN KEY (tipodoc_org_fk) REFERENCES siges.organismos (org_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.presupuesto ADD CONSTRAINT presupuesto_pre_fuente_organi_fk_fkey FOREIGN KEY (pre_fuente_organi_fk) REFERENCES siges.fuente_financiamiento (fue_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.lineabase_historico ADD CONSTRAINT "lineabase_historico_lineabase_entFk_fkey" FOREIGN KEY ("lineabase_entFk") REFERENCES siges.entregables (ent_pk) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE siges.proy_pre ADD CONSTRAINT proy_pre_proypre_pre_fk_fkey FOREIGN KEY (proypre_pre_fk) REFERENCES siges.presupuesto (pre_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.prog_tags ADD CONSTRAINT prog_tags_progtag_area_pk_fkey FOREIGN KEY (progtag_area_pk) REFERENCES siges.areas_tags (arastag_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.ss_rel_rol_operacion ADD CONSTRAINT ss_rel_rol_operacion_rel_rol_operacion_operacion_id_fkey FOREIGN KEY (rel_rol_operacion_operacion_id) REFERENCES siges.ss_operacion (ope_id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE siges.objetivos_estrategicos ADD CONSTRAINT obj_est_org_fk FOREIGN KEY (obj_est_org_fk) REFERENCES siges.organismos (org_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.ss_localidades ADD CONSTRAINT ss_localidades_loc_depto_id_fkey FOREIGN KEY (loc_depto_id) REFERENCES siges.ss_departamentos (depto_id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE siges.organi_int_prove ADD CONSTRAINT organi_int_prove_orga_amb_fk_fkey FOREIGN KEY (orga_amb_fk) REFERENCES siges.ambito (amb_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.roles_interesados ADD CONSTRAINT roles_interesados_rolint_org_fk_fkey FOREIGN KEY (rolint_org_fk) REFERENCES siges.organismos (org_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.areas ADD CONSTRAINT fk_j151q3d1wiqgx10w9n92hwx5j FOREIGN KEY (area_director) REFERENCES siges.ss_usuario (usu_id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.plantilla_entregables ADD CONSTRAINT plantilla_entregables_p_entregable_p_cro_fk_fkey FOREIGN KEY (p_entregable_p_cro_fk) REFERENCES siges.plantilla_cronograma (p_crono_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.ss_usuario ADD CONSTRAINT ss_usuario_usu_area_org_fkey FOREIGN KEY (usu_area_org) REFERENCES siges.areas (area_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.plantilla_cronograma ADD CONSTRAINT plantilla_cronograma_p_crono_org_fk_fkey FOREIGN KEY (p_crono_org_fk) REFERENCES siges.organismos (org_pk) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE siges.productos ADD CONSTRAINT productos_prod_ent_fk_fkey FOREIGN KEY (prod_ent_fk) REFERENCES siges.entregables (ent_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.riesgos ADD CONSTRAINT riesgos_risk_ent_fk_fkey FOREIGN KEY (risk_ent_fk) REFERENCES siges.entregables (ent_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.registros_horas ADD CONSTRAINT registros_horas_rh_ent_fk_fkey FOREIGN KEY (rh_ent_fk) REFERENCES siges.entregables (ent_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.proy_otros_cat_secundarias ADD CONSTRAINT proy_otros_cat_secundarias_proy_cat_cat_proy_fk_fkey FOREIGN KEY (proy_cat_cat_proy_fk) REFERENCES siges.categoria_proyectos (cat_proy_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.tipo_gasto ADD CONSTRAINT tipo_gasto_tipogas_org_fk_fkey FOREIGN KEY (tipogas_org_fk) REFERENCES siges.organismos (org_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.adquisicion ADD CONSTRAINT adquisicion_componente_producto_fk FOREIGN KEY (adq_componente_producto_fk) REFERENCES siges.componente_producto (com_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.latlng_proyectos ADD CONSTRAINT latlng_proyectos_latlang_dep_fk_fkey FOREIGN KEY (latlang_dep_fk) REFERENCES siges.departamentos (dep_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.devengado ADD CONSTRAINT devengado_dev_adq_fk_fkey FOREIGN KEY (dev_adq_fk) REFERENCES siges.adquisicion (adq_pk) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE siges.programas ADD CONSTRAINT programas_prog_area_fk_fkey FOREIGN KEY (prog_area_fk) REFERENCES siges.areas (area_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.ambito ADD CONSTRAINT fk_n5tl58dqv18cs790jbmejxom2 FOREIGN KEY (amb_org_fk) REFERENCES siges.organismos (org_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.valor_hora ADD CONSTRAINT valor_hora_val_hor_mon_fk_fkey FOREIGN KEY (val_hor_mon_fk) REFERENCES siges.moneda (mon_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.doc_file ADD CONSTRAINT fk_n76rhuste8gi3p3jq7m91j7iq FOREIGN KEY (docfile_doc_fk) REFERENCES siges.documentos (docs_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.busq_filtro ADD CONSTRAINT fk_a726jrgroi6p90dip38n70ftp FOREIGN KEY (busq_filtro_org_fk) REFERENCES siges.organismos (org_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.pagos ADD CONSTRAINT pagos_pag_adq_fk_fkey FOREIGN KEY (pag_adq_fk) REFERENCES siges.adquisicion (adq_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE siges.personas ADD CONSTRAINT personas_pers_orga_fk_fkey FOREIGN KEY (pers_orga_fk) REFERENCES siges.organi_int_prove (orga_pk) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE siges.temas_calidad ADD CONSTRAINT temas_calidad_tca_org_fk_fkey FOREIGN KEY (tca_org_fk) REFERENCES siges.organismos (org_pk) ON UPDATE NO ACTION ON DELETE NO ACTION;
