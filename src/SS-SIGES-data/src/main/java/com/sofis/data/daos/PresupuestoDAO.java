...
//        String query = "select sum(proy_ind_pre.proyindpre_pv)\n"
//                + "from \n"
//                + "	proy_indices_pre proy_ind_pre inner join\n"
//                + "    proy_indices proy_ind on (proy_ind_pre.proyindpre_proyind_fk = proy_ind.proyind_pk) inner join\n"
//                + "    proyectos p on (p.proy_proyindices_fk = proy_ind.proyind_pk)\n"
//                + "where \n"
//                + "	p.proy_activo = true and\n"
//                + "    p.proy_prog_fk = :progPk and \n"
//                + "    proy_ind_pre.proyindpre_mon_fk = :monPk";
//
//        Query q = super.getEm().createNativeQuery(query);
//        q.setParameter("progPk", progPk);
//        q.setParameter("monPk", monPk);
//        Double reutValue = (Double) q.getSingleResult();
//        if (reutValue == null) {
...
//        String query = "select sum(proy_ind_pre.proyindpre_ac)\n"
//                + "from \n"
//                + "	proy_indices_pre proy_ind_pre inner join\n"
//                + "    proy_indices proy_ind on (proy_ind_pre.proyindpre_proyind_fk = proy_ind.proyind_pk) inner join\n"
//                + "    proyectos p on (p.proy_proyindices_fk = proy_ind.proyind_pk)\n"
