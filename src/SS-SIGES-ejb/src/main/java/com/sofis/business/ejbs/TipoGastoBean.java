...
public class TipoGastoBean {
    ...
    private static final Logger logger = Logger.getLogger(TipoGastoBean.class.getName());
    @Inject
...
//		MatchCriteriaTO criterio = CriteriaTOUtils.createMatchCriteriaTO(MatchCriteriaTO.types.CONTAINS, "tipogasNombre", filtroNombre);
		CriteriaTO criterio = DAOUtils.createMatchCriteriaTOString("tipogasNombre", filtroNombre);
...
//	    MatchCriteriaTO criterioNombre = CriteriaTOUtils.createMatchCriteriaTO(MatchCriteriaTO.types.EQUALS, "tipogasNombre", tipoGastoNombre);
	    CriteriaTO criterioNombre = DAOUtils.createMatchCriteriaTOString("tipogasNombre", tipoGastoNombre);
