...
public class GastosBean {
    ...
    private static final Logger logger = Logger.getLogger(GastosBean.class.getName());
    @Inject
    ...
    public List<Gastos> obtenerRegistrosGastos(Integer usuId, Integer proyPk, Date fDesde, Date fHasta, TipoGasto tipoGasto, Long desde, Long cant, Integer aprobado, Integer orgPk) {
        ...
        try {
            ...
            if (crits.isEmpty()) {
                ...
                if (!StringsUtils.isEmpty(database) && database.equalsIgnoreCase(ConstanteApp.DB_POSTGRESQL)) {
                    orderBy1 = new String[]{};
                    orderBy2 = new boolean[]{};
                }
