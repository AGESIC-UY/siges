...
public class OrganiIntProveBean {
	...
	public List<OrganiIntProve> obtenerOrganiIntProveHabilitadosPorOrgPk(Integer orgPk, Boolean proveedor) throws GeneralException {
		...
		try {
			CriteriaTO criteriaOrg = CriteriaTOUtils.createMatchCriteriaTO(MatchCriteriaTO.types.EQUALS, "orgaOrgFk.orgPk", orgPk);
			CriteriaTO criteriaHabilitado = CriteriaTOUtils.createMatchCriteriaTO(MatchCriteriaTO.types.EQUALS, "orgaHabilitado", true);
			...
			if (proveedor != null) {
				...
				criteria = CriteriaTOUtils.createANDTO(criteriaOrg, criteriaProv, criteriaHabilitado);
			} else {
				criteria = criteriaOrg;
			}
	...
	public List<OrganiIntProve> busquedaOrgaFiltro(Integer orgPk, Map<String, Object> mapFiltro, String elementoOrdenacion, int ascendente) {
		if (orgPk != null) {
			...
			MatchCriteriaTO criterioOrg = CriteriaTOUtils.createMatchCriteriaTO(MatchCriteriaTO.types.EQUALS, "orgaOrgFk.orgPk", orgPk);
			...
			String razonSocial = mapFiltro != null ? (String) mapFiltro.get("orgaRazonSocial") : null;
			if (!StringsUtils.isEmpty(razonSocial)) {

				MatchCriteriaTO criterio = CriteriaTOUtils.createMatchCriteriaTO(MatchCriteriaTO.types.CONTAINS, "orgaRazonSocial", razonSocial);
				criterios.add(criterio);
			}
			
			Boolean habilitado = mapFiltro != null ? (Boolean) mapFiltro.get("orgaHabilitado") : null;
			if (habilitado != null) {

				MatchCriteriaTO criterio = CriteriaTOUtils.createMatchCriteriaTO(MatchCriteriaTO.types.EQUALS, "orgaHabilitado", habilitado);
				criterios.add(criterio);
			}
                        
                        String rut = mapFiltro != null ? (String) mapFiltro.get("orgaRut") : null;
			if (!StringsUtils.isEmpty(rut)) {

				MatchCriteriaTO criterio = CriteriaTOUtils.createMatchCriteriaTO(MatchCriteriaTO.types.CONTAINS, "orgaRut", rut);
				criterios.add(criterio);
			}
