...
//            return dao.findByOneProperty(Organismos.class, "orgActivo", Boolean.TRUE, "orgNombre");
    ...
    private void validarDuplicado(Organismos org) {
        System.out.println("*** validarDuplicado ***");
        List<Organismos> list = obtenerPorNombre(org.getOrgNombre());
        System.out.println("org nombre:" + org.getOrgNombre());
        System.out.println("list:" + (list != null ? list.size() : "null"));
        if (CollectionsUtils.isNotEmpty(list)) {
            for (Organismos o : list) {
                System.out.println("for o:" + o.getOrgPk() + "-" + o.getOrgNombre());
                System.out.println("for org:" + org.getOrgPk() + "-" + org.getOrgNombre());
