...
public class Estados implements Serializable {
    ...
    public String getEstLabel() {
        return estLabel != null && !estLabel.isEmpty() ? estLabel : "estado_" + estCodigo;
    }
    ...
    public Integer getEstadoCronograma(){
        if(this.estPk.equals(Estados.ESTADOS.NO_EXIGIDO.estado_id)){
                return 0;
        }else if(this.estPk.equals(Estados.ESTADOS.PENDIENTE.estado_id)){
            return 0;
        }else if(this.estPk.equals(Estados.ESTADOS.PENDIENTE_PMOT.estado_id)){
            return 0;
        }else if(this.estPk.equals(Estados.ESTADOS.PENDIENTE_PMOF.estado_id)){
            return 0;
        }else if(this.estPk.equals(Estados.ESTADOS.INICIO.estado_id)){
            return 0;
        }else if(this.estPk.equals(Estados.ESTADOS.PLANIFICACION.estado_id)){
            return 1;
        }else if(this.estPk.equals(Estados.ESTADOS.EJECUCION.estado_id)){
            return 2;
        }else if(this.estPk.equals(Estados.ESTADOS.FINALIZADO.estado_id)){
            return 3;
        }else if(this.estPk.equals(Estados.ESTADOS.SOLICITUD_FINALIZADO_PMOF.estado_id)){
            return 2;
        }else if(this.estPk.equals(Estados.ESTADOS.SOLICITUD_FINALIZADO_PMOT.estado_id)){
            return 2;
        }else if(this.estPk.equals(Estados.ESTADOS.SOLICITUD_CANCELAR_PMOT.estado_id)){
            return 3;
        }
        return 3;
    }
    
    public Boolean lineaBaseRequerida(){
        return this.getEstadoCronograma() > 1;
    }
