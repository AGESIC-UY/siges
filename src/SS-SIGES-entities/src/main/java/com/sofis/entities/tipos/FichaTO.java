...
public class FichaTO implements Serializable {
    ...
    private LatlngProyectos latlngProy;
	...
	/**
	 * 14-12-2016
	 * Debe tomar en cuenta el estado de la publicación. 
	 * No pueden publicarse proyectos que están marcados como publicables pero pendiente de carga de datos.
	 */
...
//        this.setSolAprobacion(null);
    ...
    public LatlngProyectos getLatlngProy() {
        return latlngProy;
    }

    public void setLatlngProy(LatlngProyectos latlngProy) {
        this.latlngProy = latlngProy;
    }
