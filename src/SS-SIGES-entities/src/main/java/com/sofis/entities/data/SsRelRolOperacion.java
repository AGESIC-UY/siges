...
public class SsRelRolOperacion implements Serializable {
    ...
    private Integer relRolOperacionUserCode;
    @Basic(optional = false)
    @NotNull
    ...
    public Integer getRelRolOperacionUserCode() {
        return relRolOperacionUserCode;
    }

    public void setRelRolOperacionUserCode(Integer relRolOperacionUserCode) {
        this.relRolOperacionUserCode = relRolOperacionUserCode;
    }
