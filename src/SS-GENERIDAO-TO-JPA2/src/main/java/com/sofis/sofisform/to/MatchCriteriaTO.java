...
//			} else if (matchType.equals(MatchCriteriaTO.types.IN.type) || matchType.equals(MatchCriteriaTO.types.NOT_IN.type)) {
//				toReturn = "( :" + index + "." + property + " "+ matchTypeToQuery() + this.getComponent().getKey() + ")";
...
//		if (matchType.equals(MatchCriteriaTO.types.IN.type)) {
//			return "  IN ";
//		}
//		if (matchType.equals(MatchCriteriaTO.types.NOT_IN.type)) {
//			return "  NOT IN ";
//		}
