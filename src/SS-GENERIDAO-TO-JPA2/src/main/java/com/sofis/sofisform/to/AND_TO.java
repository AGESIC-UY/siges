 ...
 */
public class AND_TO extends ContainerCriteriaTO implements Serializable{
    ...
    public AND_TO(CriteriaTO criteria1, CriteriaTO criteria2) {
    ...
    public String getStringQuery(HashMap col, HashMap leftJoin) {
        ...
        if (criteria1S != null && criteria2S != null){
            return "( (" + criteria1S + ") and (" + criteria2S + ") )";
        }
    ...
    public Element toXML() {
      Element toReturn = new Element("AND");
